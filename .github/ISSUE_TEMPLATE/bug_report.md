...
<!-- Attaching your full jiji config can help diagnose the problem. -->
...
$ readlink /proc/$(jiji msg --json pick-window | jq .pid)/exe

If this points to xwayland-satellite, then it's an X11 window.

Please report issues with X11 apps to xwayland-satellite instead of jiji: https://github.com/Supreeeme/xwayland-satellite/issues
-->

### System Information

<!-- Paste the output of `jiji -V`, e.g. jiji 25.02 (b94a5db) -->
* jiji version: 
