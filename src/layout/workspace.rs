...
impl<W: LayoutElement> Workspace<W> {
    ...
    pub fn update_layout_config(&mut self, layout_config: Option<jiji_config::LayoutPart>) {
...
fn compute_workspace_shadow_config(
    config: jiji_config::WorkspaceShadow,
    view_size: Size<f64, Logical>,
) -> jiji_config::Shadow {
    ...
    let mut config = jiji_config::Shadow::from(config);
