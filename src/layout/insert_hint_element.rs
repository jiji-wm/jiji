...
impl InsertHintElement {
    pub fn new(config: jiji_config::InsertHint) -> Self {
        Self {
            inner: FocusRing::new(jiji_config::FocusRing {
                off: config.off,
                width: 0.,
    ...
    pub fn update_config(&mut self, config: jiji_config::InsertHint) {
        self.inner.update_config(jiji_config::FocusRing {
            off: config.off,
            width: 0.,
            active_color: config.color,
            inactive_color: config.color,
