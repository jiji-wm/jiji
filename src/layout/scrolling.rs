...
use jiji_config::{CenterFocusedColumn, PresetSize, Struts};
...
impl<W: LayoutElement> ScrollingSpace<W> {
    ...
    fn activate_column_with_anim_config(&mut self, idx: usize, config: jiji_config::Animation) {
    ...
    pub fn add_tile(
        ...
        width: ColumnWidth,
        is_full_width: bool,
        anim_config: Option<jiji_config::Animation>,
    ) {
