...
use jiji_config::{Action, Bind, Config, Key, ModKey, Modifiers, Trigger};
...
fn action_name(action: &Action) -> String {
    match action {
        ...
        Action::MoveWindowToNewWorkspaceDown(_) => {
        ...
        Action::CaptureBookmarkKey { .. } => String::from("Capture Bookmark Key"),
...
fn key_name(screen_reader: bool, mod_key: ModKey, key: &Key) -> String {
    ...
    let pretty = match key.trigger {
        ...
        Trigger::ModTap => String::from("Mod (tap)"),
